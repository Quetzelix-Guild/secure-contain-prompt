...
For example: Object Class: Euclid / Cascade-Risk
...
Reason: The core failure is delegated system access and constraint inheritance failure. Recursive dynamics appear when helper agents spawn additional helper agents or tool chains.
