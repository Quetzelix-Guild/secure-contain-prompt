...
## SCP Inspiration and Non-Affiliation

This project is inspired by the collaborative fiction format associated with the SCP Foundation/SCP Wiki.
...
Unless otherwise noted, this project is licensed under the **Creative Commons Attribution-ShareAlike 3.0 Unported License**.
...
Developed through multi-model exploratory drafting and critique involving ChatGPT, Claude, Grok, and Gemini.

## Forking and Adaptation

Forks, remixes, expansions, and derivative entries are welcome under the terms of CC BY-SA 3.0.

Contributors should preserve attribution, indicate meaningful changes, and release derivative work under the same license.

## Editorial Principle

The joke must be diagnostic.

Entries should use humor, mythic framing, and cryptid/SCP-style presentation to clarify real agentic failure modes—not to obscure them.
